...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("No need to elevate", "Nereikia suteikti papildomų teisių"),
        ("System Sound", "Sistemos garsas"),
        ("Default", "Numatytoji"),
        ("New RDP", "Naujas RDP"),
        ("Fingerprint", "Piršto antspaudas"),
        ("Copy Fingerprint", "Kopijuoti piršto antspaudą"),
        ("no fingerprints", "nėra piršo antspaudų"),
        ("Select a peer", "Pasirinkti lygiavertį"),
        ("Select peers", "Pasirinkti lygiaverčius"),
        ("Plugins", "Įskiepiai"),
        ("Uninstall", "Pašalinti"),
        ("Update", "Atnaujinti"),
        ("Enable", "Įgalinti"),
        ...
        ("Accept and Elevate", "Sutikti ir suteikti teises"),
        ...
        ("Open", "Atverti"),
        ("logout_tip", ""),
        ("Service", "Foninė paslauga"),
        ("Start", "Pradėti"),
        ("Stop", "Sustabdyti"),
        ("exceed_max_devices", ""),
        ("Sync with recent sessions", ""),
        ("Sort tags", "Rūšiuoti žymes"),
        ("Open connection in new tab", "Atidaryti ryšį naujame skirtuke"),
        ...
        ("Change Color", "Pakeisti spalvą"),
        ("Primary Color", "Pirminė spalva"),
        ("HSV Color", "HSV spalva"),
        ("Installation Successful!", "Diegimas pavyko!"),
        ("Installation failed!", "Diegimas nepavyko!"),
        ("Reverse mouse wheel", "Atvirkščias pelės ratukas"),
        ("{} sessions", "{} sesijos"),
        ("scam_title", ""),
        ("scam_text1", ""),
        ("scam_text2", ""),
        ...
        ("I Agree", "Sutinku"),
        ("Decline", "Atmesti"),
        ("Timeout in minutes", "Laukimo laikas minutėmis"),
        ("auto_disconnect_option_tip", ""),
        ("Connection failed due to inactivity", ""),
        ("Check for software update on startup", "Patikrinti atnaujinimus paleidžiant"),
        ...
        ("Show displays as individual windows", "Rodyti ekranus atskiruose languose"),
        ("Use all my displays for the remote session", "Naudoti visus mano ekranus nuotolinei sesijai"),
        ("selinux_tip", ""),
        ("Change view", "Pakeisti vaizdą"),
        ("Big tiles", "Didelės plokštelės"),
        ("Small tiles", "Mažos plokštelės"),
        ("List", "Sąrašas"),
        ("Virtual display", "Virtualus ekranas"),
        ("Plug out all", "Išjungti visus"),
        ("True color (4:4:4)", ""),
        ...
        ("wrong-2fa-code", ""),
        ("enter-2fa-title", ""),
        ("Email verification code must be 6 characters.", "El. pašto patvirtinimo kodas turi būti 6 simbolių ilgio."),
        ...
        ("Security Alert", "Saugumo pranešimas"),
        ("My address book", "MAno adresų knygelė"),
        ("Personal", "Asmininė"),
        ("Owner", "Savininkas"),
        ("Set shared password", "Nustatyti bendrą slaptažodį"),
        ("Exist in", "Egzistuoja"),
        ("Read-only", "Tik-skaitymui"),
        ("Read/Write", "Skaitymas/rašymas"),
        ("Full Control", "Pilnas valdymas"),
        ("share_warning_tip", ""),
        ("Everyone", "Visi"),
        ("ab_web_console_tip", ""),
        ("allow-only-conn-window-open-tip", ""),
        ("no_need_privacy_mode_no_physical_displays_tip", ""),
        ("Follow remote cursor", "Sekti nuotolinės pelytės judėjimą"),
        ("Follow remote window focus", "Sekti nuotolinio lango fokusą"),
    ].iter().cloned().collect();
}
